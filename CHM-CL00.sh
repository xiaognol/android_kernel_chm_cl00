...
export CROSS_COMPILE=/home/zjl/mkm/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android-
export TARGET_PRODUCT=CHM-CL00
ROOT_DIR=$PWD
...
make -j4 O=./obj/KERNEL_OBJ/ chm_mokee_defconfig
...
mkdir $IMAGE_OUT_DIR
KERNEL_MAKE/mktools/dtbToolCM -o obj/bootimg_out/dt.img -s 2048  -p obj/KERNEL_OBJ/scripts/dtc/ obj/KERNEL_OBJ/arch/arm64/boot/dts/
